...
def create_sma_filter(sma_values):
    ...
    for sma in sma_values:
        ...
        # Add options with other SMAs
        for compare_sma in sma_values:
            if sma != compare_sma:  # Ignore comparing with itself
...
def create_home_navbar():
    ...
    return html.Div(
        [
            ...
            # RSI Inputs
            html.Div([
                html.Div([html.H3("RSI", style={"color": "white", "fontWeight": "bold"})],
                         style={"textAlign": "center", "marginBottom": "20px"}),
                html.Div(
                    [
                        dcc.Input(
                            id="min_rsi", type="number", placeholder="Min RSI",
                            style={"width": "40%", "marginRight": "10px"}
                        ),
                        dcc.Input(
                            id="max_rsi", type="number", placeholder="Max RSI",
                            style={"width": "40%"}
                        ),
                    ],
            ...
            # MACD
            html.Div([
                html.Div([html.H3("MACD Signals", style={"color": "white", "fontWeight": "bold"})],
                         style={"textAlign": "center", "marginBottom": "10px"}),
                dcc.Dropdown(
                    id="macd_signal",
                    options=[
...
def create_stock_graph_navbar():
    return html.Div(
        [
            html.H2("Stock Graph", style={"textAlign": "center", "color": "white"}),

            # Navigation Links
            html.Div([
                dcc.Link("Home", href="/", style={"color": "white", "marginRight": "10px"}),
            ], style={"textAlign": "center", "marginBottom": "20px"}),
        ],
        style={
            "backgroundColor": "grey",
